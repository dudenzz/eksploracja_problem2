...
def run_comparison():
    ...
    print("="*50)
    print(f"BENCHMARK: FP-Growth Solutions (n={ITERATIONS}); Eclata 155093 (n={ITERATIONS})")
    ...
    try:
        solution_stats = benchmark_solution(solution155093, "Eclata 155093", ITERATIONS, MIN_SUPPORT, MIN_CONFIDENCE)
        results.append(solution_stats)
    except Exception as e:
        print(f"Błąd podczas testu solution: {e}")
