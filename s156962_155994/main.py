...
def run_comparison():
    ...
    results = []
     ...
     # Test Eclat 
    try:
        eclat_stats = benchmark_solution(solution_156962_155994, "Eclat", ITERATIONS, MIN_SUPPORT, MIN_CONFIDENCE)
        results.append(eclat_stats)
    except Exception as e:
        print(f"Błąd podczas testu Eclat: {e}")
